...
class Test (unittest.TestCase):
    ...
    def test_encrypt_decrypt (self):
        ...
        encrypted = self.gpg.encrypt (self.message, receiver.fingerprint, sender.fingerprint, 'sender_pwd')
        ...
        self.assertRaises (regnupg.GeneralError, self.gpg.encrypt, self.message, receiver.fingerprint, 'fakekey', 'sender_pwd')
